...
public struct ToneAnalysis {
    ...
    public init(json: JSON) {
        documentTone = json["document_tone"]["tone_categories"].arrayValue.map(ToneCategory.init)
        sentencesTones = json["sentences_tone"].arrayValue.map(SentenceAnalysis.init)
